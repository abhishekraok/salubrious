...
def export_profile(db: Session = Depends(get_db), user: UserProfile = Depends(get_current_user)):
    ...
    export_data = {
        ...
        "policy": {
            ...
            "expected_years_remaining": policy.expected_years_remaining,
            "expected_years_earning": policy.expected_years_earning,
            "expected_after_tax_salary": policy.expected_after_tax_salary,
